...
import data from "@/components/section/hero/data";
...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative h-screen flex flex-col lg:flex-row items-center justify-between overflow-hidden px-4 py-16">
      {/* Left Section for Text Content */}
      <motion.div
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.5 }}
        className="container lg:w-1/2 text-center mb-12 mt-12 lg:mb-0 lg:mt-12 "
      >
        <h1 className="text-6xl font-semibold mb-2">
          ...
          <span className="ml-2">
            <Cover
              ...
              bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 cursor-pointer xl:tracking-wider"
            >
              Shwetank
            </Cover>
          </span>
        ...
        <div className="flex justify-center gap-6 items-center mt-10">
          <Link href="/contact">
            <motion.button
              className="flex items-center justify-center w-full border-2 border-purple-500 text-purple-500 font-semibold py-2 px-8 rounded-full shadow-md hover:bg-purple-500 hover:text-white transition-all duration-300 ease-in-out transform hover:scale-105 hover:translate-y-1"
              whileHover={{
                scale: 1.05,
                rotate: -5,
              }}
            ...
            >
              ...
              <span className="text-lg hidden sm:hidden md:hidden lg:block">
                Contact Me
              </span>
            </motion.button>
          </Link>
